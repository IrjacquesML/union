...
('Bienvenue à l''UCO', 'Union du Congo Ouest — Adventistes du 7e Jour', '/assets/img/adventist-church-hero.jpg', '/pages/mission', 'Notre mission', 1, 1),
('Une foi vivante', 'Adoration, communauté et espérance', '/assets/img/adventist-worship.jpg', '/croyances', 'Nos croyances', 2, 1),
('Au service de la communauté', 'Jeunesse, mission et engagement', '/assets/img/adventist-community.jpg', '/associations', 'Nos associations', 3, 1);
