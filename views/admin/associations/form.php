...
<form method="post" action="<?= $association ? '/admin/associations/' . (int) $association['id'] : '/admin/associations' ?>" enctype="multipart/form-data" class="form admin-form">
    <?= csrf_field() ?>
    <label>Nom *</label>
    ...
    <?php if (!empty($association['cover_image'])): ?><img src="<?= e($association['cover_image']) ?>" alt="" class="thumb"><?php endif; ?>
