...
<form method="post" action="<?= $department ? '/admin/departments/' . (int) $department['id'] : '/admin/departments' ?>" enctype="multipart/form-data" class="form admin-form">
    <?= csrf_field() ?>
    <label>Nom *</label>
    ...
    <?php if (!empty($department['cover_image'])): ?><img src="<?= e($department['cover_image']) ?>" alt="" class="thumb"><?php endif; ?>
    <div class="form-grid">
