<?php /** @var array $item */ $yt = youtube_id($item['external_url'] ?? null); ?>
<section class="page-hero"><div class="container"><small><?= e($item['type']) ?></small><h1><?= e($item['title']) ?></h1></div></section>
<section class="section">
    <div class="container prose">
        <?php if (!empty($item['thumbnail'])): ?>
            <img class="cover-img" src="<?= e($item['thumbnail']) ?>" alt="">
        <?php endif; ?>
        <?php if ($item['speaker']): ?><p><strong>Intervenant :</strong> <?= e($item['speaker']) ?></p><?php endif; ?>
        <?= nl2br(e($item['description'] ?? '')) ?>
        <?php if ($yt): ?>
            <div class="media-embed">
                <iframe src="https://www.youtube-nocookie.com/embed/<?= e($yt) ?>" title="<?= e($item['title']) ?>" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
