...
SELECT * FROM (
    SELECT 'Bienvenue à l''UCO' AS title,
           ...
           '/assets/img/adventist-church-hero.jpg' AS image_path,
...
SQL);
    ...
    $pdo->exec(<<<'SQL'
INSERT INTO carousel_slides (title, subtitle, image_path, link_url, link_label, sort_order, is_active)
SELECT 'Une foi vivante', 'Adoration, communauté et espérance', '/assets/img/adventist-worship.jpg', '/croyances', 'Nos croyances', 2, 1
FROM DUAL
...
SQL);
    ...
    $pdo->exec(<<<'SQL'
INSERT INTO carousel_slides (title, subtitle, image_path, link_url, link_label, sort_order, is_active)
SELECT 'Au service de la communauté', 'Jeunesse, mission et engagement', '/assets/img/adventist-community.jpg', '/associations', 'Nos associations', 3, 1
FROM DUAL
